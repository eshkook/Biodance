...
export default function ProtectedRoute({ children }) {
    ...
    return <Navigate to="/login" state={{ message: location.state?.no_failure_message ? false : (location.state?.custom_failure_message ? location.state.custom_failure_message : 'Authentication failed, please try to log in again.') }} />
    ////////////////////////////////////////////////////////////////////////////
